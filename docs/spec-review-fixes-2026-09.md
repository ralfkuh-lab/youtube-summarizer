...
| `src/main.ts` | Imports, Template rendern, `init…()`-Aufrufe, `bindEvents()` als Verdrahtung der `bind…Events()`, `isModalOpen`, `bindEscapeToCloseModals`, `loadInitialData` |
